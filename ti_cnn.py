...
train_images = read_images(trian_image_file_name)/255.0

test_image_file_name = 'handwrite_data/t10k-images.idx3-ubyte'
test_images = read_images(test_image_file_name)/255.0
...
test_label_file_name = 'handwrite_data/t10k-labels.idx1-ubyte'
test_labels = read_labels(test_label_file_name)
print("size of test set:{}".format(test_labels.shape[0])) #10000
...
unsuccess = cnntest(cnn,test_images,test_labels,test_labels.shape[0]) #10000
